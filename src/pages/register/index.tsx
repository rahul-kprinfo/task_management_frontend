...
function Register() {
  ...
  return (
    <div className="flex justify-center items-center	 h-[100vh]">
      <div className=" bg-gray-200 w-[700px] min-h-80  p-[30px] rounded-[10px]">
        <div>
          <h2 className="text-center font-bold">Task Management-Register</h2>
        </div>
            ...
            >
              <div className="flex flex-col">
                ...
                {formik.touched.name && formik.errors.name ? (
                  <div className="ml-5 text-red-600">{formik.errors.name}</div>
                ) : null}
              </div>
              <div className="flex flex-col">
              ...
              <input
                type="submit"
                value="Register"
                className="bg-green-500 w-[100px] h-[40px] rounded-md  text-white cursor-pointer hover:bg-green-600 mt-9"
              />
            </form>
          </div>
          <div className="mr-6">
